...
This work is divided into 5 chapters. In the first chapter, we will introduce the concept of complex systems and the importance of stochastic processes in the study of these systems. 
In particular, a brief overview of point processes and Hawkes processes, which are the main focus of this work, will be presented. Additionally, we will introduce the concept of criticality
and its relevance in the study of complex systems and its relationship with biological systems. After that, we will present the objectives of this work. 
In the third chapter, we will present the methodology used in this work, including the simulation of Hawkes processes, 
...
so we will use them indistinctly. 
