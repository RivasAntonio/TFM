...
In this case, the self-excitation does not lead to a critical dynamics but to a supercritical dynamics. In this situation, the time until the first event occurs is given on average by $\mu^{-1}$.
