...
\begin{figure}[H]
    ...
    \caption{Raster plots of Hawkes processes with $n=2$. In both cases, the number of events is $K=10^3$, they also have the same structure, the first event happens in $\mu^{-1}a.u.$ time and 
    an avalanche of events takes place.}
