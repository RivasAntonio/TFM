...
\begin{figure}[H]
    ...
    \caption{Diagram for the second configuration. Red lines represent the events, clusters are coloured. As we can see, we have two regimes, one when $\Delta$ is of the order of the average 
...
the average cluster size. This phenomena is illustrated in Figure \ref{f: Delta percolación 2}. HACER IMAGEN DE ESTE CASO EN CANVA.
