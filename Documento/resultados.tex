...
situation as in the case of $n=1$ and $\mu=10^-4$, as illustrated in Figure %\ref{f:avalanches_coupled critical}.

DESCOMENTAR ESTA LÍNEA CUANDO TENGA LAS IMÁGENES

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{stats bivariate critical 10-2.png}
...
agreeing with the universality class of 1D percolation. In this case, as Figure %\ref{f:avalanches_coupled oscilatory} 
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{stats stationary bivariate 10-2.png}
